...
<head>
    ...
    <title>Diamonds Lodge  - York - Yorkshire</title>
    <meta name="description" content="Treat Yourself at Diamonds Lodge Guest House, York. Browse Reviews. Our Price Guarantee. Check Out What Users Loved About This Property. Book the Room">
        ...
        <div class="container">
            <div class="row py-4 fs-5">
                <div class=" col-md-3 mb-3 ">
                    ...
                    <p class="text-light d-block mt-3"> Diamonds Lodge Ltd , 23 Wigginton Road, York, North Yorkshire, YO31 8HJ, United Kingdom </p>
                ...
                <div class=" col-md-3 mb-3">
                    ...
                    <p class="mb-1 darkerGrotesque-semibold d-flex align-items-center text-light"><iconify-icon
                            class=" pe-2" icon="ic:outline-email"></iconify-icon>diamondslodgeyork@gmail.com</p>
                </div>
                <div class=" col-md-3 mb-3">
